...
DICT_BIN_PATH = f"{BASE_DIR}/part_3/output/dictionary.bin"
INDEX_BIN_PATH = f"{BASE_DIR}/part_3/output/inverted_index.bin"
OUTPUT_DIR = f"{BASE_DIR}/part_4/output"
OUTPUT_FILE = f"{OUTPUT_DIR}/phrase_search_results.txt"
...
# 注意：构建器中位置使用2字节（unsigned short），并且每个posting块前有doc_count(4字节)
POSITION_SIZE = 2  # 位置信息存储大小（字节，对应构建器为2字节）
